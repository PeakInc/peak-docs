...
```text
Set up Peak in this repository. Run npx -y @peakinc/init@latest --yes --json --no-browser. Show me the sign in link it prints and wait until I approve it. Then give me the pull request link.
```
